...
public class Viking extends Warrior{
    ...
    public Viking(){
        ...
        System.out.println("Please enter a health value for your Viking.");
        ...
        System.out.println("Please enter a attack rate value for your Viking.");
        ...
        System.out.println("Please enter a defense rate value for your Viking.");
    ...
    protected void Attack(Warrior target) {
        System.out.println("Axes are flying! Viking attacked. ");
        target.Defend(attack_rate);

    }
    @Override
    protected void Defend(int taken_damage){
        System.out.println("Shields up! Viking defended himself. ");
